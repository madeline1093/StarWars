$(document).ready(function(){
    ...
    let characters = {
        ...
        "darthMaul" : {
            ...
            imageUrl: "Darth_Maul_profile.png"
        },
        "obiWan" : {
            name: "Obi Wan Kenobi",
            health: 200,
        ...
        "darthSidious" : {
            ...
            imageUrl: "darthsidious.jpg"
            }
        };
        
    //setting the variables to nothing at start of game
    //user's player
    let jediOne;
    //the remaining characters who will fight the main character
    let defenders = [];
    // populated when the user selects someone to fight
    let jediTwo;
    ...
    //rendering the characters into the game - VERY IMPORTANT
